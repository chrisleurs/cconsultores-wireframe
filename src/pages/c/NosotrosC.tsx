    ...
    <div className="min-h-screen">
      ...
      <section className="min-h-[60dvh] bg-primary flex flex-col items-center justify-center text-center px-5 md:px-10 py-20">
        ...
        <div className="flex gap-4 flex-wrap justify-center">
          ...
          <a href="/version-c/servicios/contabilidad" className="btn-uppercase border border-white/30 text-white/70 px-10 py-4 hover:text-white hover:border-white/60 transition-all duration-300">
