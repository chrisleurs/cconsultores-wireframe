...
export function getContabilidadContent(lang: Lang): ContabilidadContent {
  ...
  if (lang === "en") {
    return {
      ...
      paraQuien: [
        ...
        { title: "Independent professionals and service firms", desc: "We work with freelancers, creative agencies, consultants and real estate advisors who need more administrative control and tax compliance in their daily operation.", href: `${base}/contacto` },
      ],
  ...
  return {
    ...
    paraQuien: [
      ...
      { title: "Profesionistas independientes y empresas de servicios", desc: "Trabajamos con freelancers, agencias creativas, consultores y asesores inmobiliarios que requieren mayor control administrativo y cumplimiento fiscal en su operación diaria.", href: `${base}/contacto` },
    ],
